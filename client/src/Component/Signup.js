...
const Signup = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (json.success) {
            ...
            props.showAlert("You have already registered member", "caution");
        }
    }
                                    ...
                                    <div className="row">
                                        <div className="col-md mb-3">
                                            ...
                                            <div className="form-outline">
                                                ...
                                                <input type="text" className="form-control form-control-lg" id="name" name="name" aria-describedby="emailHelp" value={name} onChange={onChange} required/>
                                    ...
                                    <div className="row">
                                        <div className="col-md mb-3">
                                            ...
                                            <div className="form-outline">
                                                ...
                                                <input type="email" className="form-control form-control-lg" id="email" name="email" aria-describedby="emailHelp" value={email} onChange={onChange} required/>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 mb-3 pb-2">
                                            ...
                                            <div className="form-outline">
                                                ...
                                                <input type="text" className="form-control form-control-lg" id="phone_no" name="phone_no" aria-describedby="emailHelp" value={phone_no} minLength={10} onChange={onChange} required />
                                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-3 d-flex align-items-center">
                                            ...
                                            <div className="form-outline datepicker w-100">
                                                ...
                                                <input type="text" className="form-control form-control-lg" id="dob" name="dob" value={dob} onChange={onChange} required/>
